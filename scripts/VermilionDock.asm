...
TruckSpriteGFX:  INCBIN  "gfx/new_sprites/truck_sprite.2bpp"
TruckWhiteGFX:   INCBIN  "gfx/new_sprites/truck_white.2bpp"
...
.fromLeft
	...
	ld hl, wCurrentMapScriptFlags
	bit 7, [hl]
	set 7, [hl] ; wait until the next time the player presses right
	ret z
	ldh a, [hJoyHeld]
	bit B_PAD_RIGHT, a
	ret z
