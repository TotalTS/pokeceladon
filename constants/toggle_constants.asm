...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_VIRIDIAN_GYM_YUJIROU
	...
	const TOGGLE_SS_ANNE_1F_ROOMS_ROOKIE1
	const TOGGLE_SS_ANNE_1F_ROOMS_ROOKIE2
	const TOGGLE_SS_ANNE_1F_ROOMS_ROOKIE3
	const TOGGLE_SS_ANNE_1F_ROOMS_GIRL1
	const TOGGLE_SS_ANNE_1F_ROOMS_MIDDLE_AGED_MAN
	const TOGGLE_SS_ANNE_1F_ROOMS_LITTLE_GIRL
	const TOGGLE_SS_ANNE_1F_ROOMS_WIGGLYTUFF
	const TOGGLE_SS_ANNE_1F_ROOMS_GIRL2
...
;	const TOGGLE_SS_ANNE_2F_ROOMS_ROOKIE3 ; tried to add Rookie 3 but there's too many objects on that map
...
;	const TOGGLE_SS_ANNE_B1F_ROOMS_SAILOR1
;	const TOGGLE_SS_ANNE_B1F_ROOMS_SAILOR2
;	const TOGGLE_SS_ANNE_B1F_ROOMS_SAILOR3
;	const TOGGLE_SS_ANNE_B1F_ROOMS_SAILOR4
;	const TOGGLE_SS_ANNE_B1F_ROOMS_SAILOR5
;	const TOGGLE_SS_ANNE_B1F_ROOMS_FISHER
	...
	toggle_consts_for SS_ANNE_CAPTAINS_ROOM
	const TOGGLE_SSANNECAPTAINSROOM_CAPTAIN
	const TOGGLE_SSANNECAPTAINSROOM_CAPTAINPG
	
	toggle_consts_for SS_ANNE_BOW
	const TOGGLE_SSANNEBOW_SUPER_NERD
	const TOGGLE_SSANNEBOW_ROOKIE
	
	toggle_consts_for ROUTE_22_YUJIROU_PRE_GYM
	const TOGGLE_ROUTE22YUJIROU_YUJIROU
	
	toggle_consts_for CHAMPIONS_HOUSE_1F
	const TOGGLE_CHAMPIONSHOUSE1F_DAISY
	const TOGGLE_CHAMPIONSHOUSE1F_OAK
	const TOGGLE_CHAMPIONSHOUSE1F_MOM
	const TOGGLE_CHAMPIONSHOUSE1F_BILL
	const TOGGLE_CHAMPIONSHOUSE1F_BIRD
