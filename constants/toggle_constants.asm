...
; after battle and are detected in wToggleableObjectList.)
	...
	toggle_consts_for CHAMPIONS_HOUSE_2F
	const TOGGLE_CHAMPIONSHOUSE2F_CHARMANDERDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_SQUIRTLEDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_BULBASAURDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_PIKACHUDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_JIGGLYPUFFDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_SURFPIKACHUDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_GENGARDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_CLEFAIRYDOLL
	const TOGGLE_CHAMPIONSHOUSE2F_GEODUDEDOLL
