...
; Viridian City events
	...
	const EVENT_BEAT_VIRIDIAN_GYM_YUJIROU
...
; Celadon City events
	...
	const EVENT_GOT_UNIVERSITY_MAGIKARP
	const_skip
	const EVENT_1BF ; ???
	const_skip 32
...
; Fuchsia City events
	...
	const EVENT_SPOKE_TO_ERIK_IN_FUCHSIA
	const EVENT_GOT_POKEGEAR_FROM_SARA
	const EVENT_GAVE_POKEGEAR_TO_ERIK
...
; Saffron City events
	...
	const EVENT_BRIBED_SAFFRON_GUARD
	const_skip 14
...
; Route 22 events
	...
	const EVENT_BEAT_ROUTE22_SNORLAX
	const EVENT_FIGHT_ROUTE22_SNORLAX
	const_skip 1
...
; S.S. Anne events
	...
	const EVENT_TRUCK_PUSHED_RIGHT
	const EVENT_BEAT_SS_ANNE_5_TRAINER_0
	const EVENT_BEAT_SS_ANNE_5_TRAINER_1
	const EVENT_BEAT_SS_ANNE_5_TRAINER_2
	const EVENT_SSANNEBOW_NEWTRAINER
	const_skip 24
	...
	const EVENT_CAPTAIN_MOVED_TO_CORNER
	const_skip 10
	...
	const EVENT_BEAT_SS_ANNE_8_TRAINER_4
	const EVENT_BEAT_SS_ANNE_8_TRAINER_5
	const EVENT_BEAT_SS_ANNE_8_TRAINER_6
	const EVENT_SS_ANNE_1F_POSTGAME
	const_skip 8
	...
	const EVENT_BEAT_SS_ANNE_9_TRAINER_4
	const EVENT_BEAT_SS_ANNE_9_TRAINER_5
;	const EVENT_BEAT_SS_ANNE_9_TRAINER_6 ; tried to add Rookie 3 but there's too many objects on that map
	const EVENT_SS_ANNE_2F_POSTGAME
	const_skip 9
	...
	const EVENT_BEAT_SS_ANNE_10_TRAINER_6
	const EVENT_BEAT_SS_ANNE_10_TRAINER_7
	const EVENT_SS_ANNE_B1F_POSTGAME
...
; Mystery Cave events
	const_next $920
	const_skip
	const EVENT_BEAT_MYSTERYCAVE_ROOKIE1_TRAINER_0
	const EVENT_BEAT_MYSTERYCAVE_ROOKIE2_TRAINER_1
	const EVENT_BEAT_MYSTERYCAVE_BLACKBELT1_TRAINER_2
	const EVENT_BEAT_MYSTERYCAVE_BEAUTY1_TRAINER_3
	const EVENT_BEAT_MYSTERYCAVE_COOLTRAINER_F1_TRAINER_4
	const_skip 4
	const EVENT_MYSTERYCAVE_GOT_DOME_FOSSIL
	const EVENT_MYSTERYCAVE_GOT_HELIX_FOSSIL
	const EVENT_MYSTERYCAVE_GOT_HITMONLEE
	const EVENT_MYSTERYCAVE_GOT_HITMONCHAN

; Rock Tunnel events
	const_next $9B0
	const EVENT_ROCK_TUNNEL_FLASH_HELP
	...
	const EVENT_ROCK_TUNNEL_FLASH_HELP2
...
; Champion's House events
	const EVENT_CHAMPIONSHOUSE1F_BILLS_GARDEN
	const EVENT_CHAMPIONSHOUSE1F_BIRD_GIFT
	const EVENT_CHAMPIONSHOUSE1F_DRINK_TEA_WITH_DAISY
	const EVENT_CHAMPIONSHOUSE2F_USED_DOLL_SWAP
