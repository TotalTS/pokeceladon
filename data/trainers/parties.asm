...
RookieData:
; SS Anne 1F Rooms
	db 51, NIDOKING, VICTREEBEL, VAPOREON, 0
	db 53, ARBOK, ALAKAZAM, GENGAR, 0
; SS Anne 2F Rooms
	db 54, TENTACRUEL, MAGNETON, CLOYSTER, 0
	db 54, DUGTRIO, SEADRA, SNORLAX, 0
; SS Anne B1F Rooms
	db 52, ARCANINE, POLIWRATH, RAPIDASH, 0
	db 52, JYNX, MR_MIME, VILEPLUME, 0
; SS Anne Bow
	db 50, MACHOKE, GOLEM, 0
; Mystery Cave
	db 55, PIDGEOT, ELECTABUZZ, CHARIZARD, 0
	db 51, ELECTRODE, PRIMEAPE, PORYGON, 0
...
; Mystery Cave
	db 55, STARMIE, SEAKING, CLOYSTER, 0
; Route 19
...
; Mystery Cave
	db 50, MACHAMP, HITMONCHAN, HITMONLEE, PRIMEAPE, 0
...
; Rematch
	db $FF, 56, ONIX, 56, KABUTOPS, 56, OMASTAR, 56, AERODACTYL, 57, GOLEM, 0

MistyData:
	db $FF, 18, STARYU, 21, STARMIE, 0
; Rematch
	db $FF, 56, GOLDUCK, 56, DEWGONG, 56, STARMIE, 56, VAPOREON, 57, GYARADOS, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, 0
; Rematch
	db $FF, 56, ELECTRODE, 56, JOLTEON, 56, ELECTABUZZ, 56, MAGNETON, 57, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
; Rematch
	db $FF, 56, TANGELA, 56, PARASECT, 56, VICTREEBEL, 56, EXEGGUTOR, 57, VILEPLUME, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, KOFFING, 43, WEEZING, 0
; Rematch
	db $FF, 56, TENTACRUEL, 56, GOLBAT, 56, WEEZING, 56, VENOMOTH, 57, MUK, 0

BlaineData:
	db $FF, 42, GROWLITHE, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, 0
; Rematch
	db $FF, 56, MAGMAR, 56, RAPIDASH, 56, NINETALES, 56, FLAREON, 57, ARCANINE, 0

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, 0
; Rematch
	db $FF, 56, MR_MIME, 56, JYNX, 56, HYPNO, 56, SLOWBRO, 57, ALAKAZAM, 0
