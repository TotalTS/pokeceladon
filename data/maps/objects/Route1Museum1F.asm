...
Route1Museum1F_Object:
	...
	object_event 68,  1, SPRITE_HO_OH, STAY, NONE,  TEXT_ROUTE1MUSEUM1F_HO_OH
	object_event 69,  1, SPRITE_LUGIA, STAY, NONE,  TEXT_ROUTE1MUSEUM1F_LUGIA
	object_event 32,  3, SPRITE_GRAMPS, STAY, DOWN, TEXT_ROUTE1MUSEUM1F_GRAMPS
