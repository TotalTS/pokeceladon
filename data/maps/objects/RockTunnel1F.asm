	...
	const_export ROCKTUNNEL1F_FISHING_GURU
	const_export ROCKTUNNEL1F_PIKACHU
...
RockTunnel1F_Object:
	...
	object_event 20,  4, SPRITE_FISHING_GURU, STAY, DOWN, TEXT_ROCKTUNNEL1F_FISHING_GURU
	object_event 21,  4, SPRITE_PIKACHU, STAY, DOWN, TEXT_ROCKTUNNEL1F_PIKACHU
