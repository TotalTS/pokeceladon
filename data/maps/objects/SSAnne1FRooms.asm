...
SSAnne1FRooms_Object:
	...
	object_event  1, 14, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_SSANNE1FROOMS_ROOKIE1, OPP_ROOKIE, 16
	object_event  3, 12, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_SSANNE1FROOMS_ROOKIE2, OPP_ROOKIE, 17
	object_event 22,  2, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_SSANNE1FROOMS_ROOKIE3, OPP_ROOKIE, 1
