...
Route6_Object:
	...
	object_event  0, 15, SPRITE_BUG_CATCHER, STAY, RIGHT, TEXT_ROUTE6_YOUNGSTER1, OPP_BUG_CATCHER, 10
	...
	object_event 19, 26, SPRITE_BUG_CATCHER, STAY, LEFT, TEXT_ROUTE6_YOUNGSTER2, OPP_BUG_CATCHER, 11
