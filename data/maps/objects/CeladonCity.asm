	...
	const_export CELADONCITY_GIRL2
...
CeladonCity_Object:
	...
	bg_event 18,  9, TEXT_CELADONCITY_UNIVERSITY_SIGN

	def_object_events
	object_event  8, 17, SPRITE_LITTLE_GIRL, WALK, ANY_DIR, TEXT_CELADONCITY_LITTLE_GIRL
	object_event 11, 28, SPRITE_GIRL, STAY, DOWN, TEXT_CELADONCITY_GIRL2
	...
	object_event 30, 12, SPRITE_POLIWRATH, STAY, RIGHT, TEXT_CELADONCITY_POLIWRATH
