...
Route20_Object:
	...
	object_event 68, 11, SPRITE_SWIMMER_GIRL, STAY, UP, TEXT_ROUTE20_SWIMMER2, OPP_BEAUTY, 15
	object_event 45, 10, SPRITE_SWIMMER_GIRL, STAY, DOWN, TEXT_ROUTE20_SWIMMER3, OPP_BEAUTY, 6
	object_event 55, 14, SPRITE_SWIMMER_GIRL, STAY, RIGHT, TEXT_ROUTE20_SWIMMER4, OPP_JR_TRAINER_F, 24
	...
	object_event 25,  7, SPRITE_SWIMMER_GIRL, STAY, UP, TEXT_ROUTE20_SWIMMER7, OPP_BEAUTY, 7
	object_event 24, 12, SPRITE_SWIMMER_GIRL, STAY, DOWN, TEXT_ROUTE20_SWIMMER8, OPP_JR_TRAINER_F, 16
	object_event 15,  8, SPRITE_SWIMMER_GIRL, STAY, UP, TEXT_ROUTE20_SWIMMER9, OPP_BEAUTY, 8
