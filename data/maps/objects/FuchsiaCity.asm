...
FuchsiaCity_Object:
	...
	object_event 31,  5, SPRITE_CHANSEY, STAY, NONE, TEXT_FUCHSIACITY_CHANSEY
	object_event 25,  6, SPRITE_FUCHSIA_MON, STAY, DOWN, TEXT_FUCHSIACITY_VOLTORB
	object_event 12,  6, SPRITE_MONSTER, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_KANGASKHAN
	object_event 30, 12, SPRITE_FUCHSIA_MON, STAY, LEFT, TEXT_FUCHSIACITY_SLOWPOKE
	object_event  8, 17, SPRITE_LAPRAS, STAY, NONE, TEXT_FUCHSIACITY_LAPRAS
	object_event  6,  5, SPRITE_FUCHSIA_MON, STAY, UP, TEXT_FUCHSIACITY_FOSSIL
