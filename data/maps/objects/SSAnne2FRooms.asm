...
SSAnne2FRooms_Object:
	...
	object_event 20,  3, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_SSANNE2FROOMS_ROOKIE1, OPP_ROOKIE, 3
	object_event 23,  3, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_SSANNE2FROOMS_ROOKIE2, OPP_ROOKIE, 4
