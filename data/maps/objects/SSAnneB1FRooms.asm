	...
	const_export SSANNEB1FROOMS_ROOKIE1
	const_export SSANNEB1FROOMS_ROOKIE2
...
SSAnneB1FRooms_Object:
	...
	object_event 10, 14, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_SSANNEB1FROOMS_ROOKIE1, OPP_ROOKIE, 8
	object_event 10, 12, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_SSANNEB1FROOMS_ROOKIE2, OPP_ROOKIE, 9
	object_event 10, 13, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_SSANNEB1FROOMS_SUPER_NERD
	object_event 11, 12, SPRITE_FIGHTER_MACHOP, STAY, NONE, TEXT_SSANNEB1FROOMS_MACHOKE
