...
SSAnneB1FRooms_Object:
	...
	object_event 10, 14, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_SSANNEB1FROOMS_ROOKIE1, OPP_ROOKIE, 5
	object_event 10, 12, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_SSANNEB1FROOMS_ROOKIE2, OPP_ROOKIE, 6
	object_event 10, 13, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_SSANNEB1FROOMS_SUPER_NERD
	object_event 11, 12, SPRITE_FIGHTER_MACHOP, STAY, DOWN, TEXT_SSANNEB1FROOMS_MACHOKE
