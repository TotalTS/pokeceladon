...
Route25_Object:
	...
	warp_event 48,  4, BILLS_HOUSE, 3
	warp_event 45,  2, BILLS_HOUSE, 4
	warp_event 46,  2, BILLS_HOUSE, 4
	warp_event 17, 33, ROUTE_25_LONG_HOUSE, 1
	...
	object_event 24,  6, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_ROUTE25_COOLTRAINER_M, OPP_JR_TRAINER_M, 2
	...
	object_event 22,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE25_TM_SEISMIC_TOSS, TM_SEISMIC_TOSS
