...
MapSpriteSets:
	...
	db SPLITSET_ROUTE_19         ; ROUTE_19
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_20
	...
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_1_WEST
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_1_EAST
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_0_WEST
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_0_EAST
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_21_WEST
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_21_EAST
...
SplitMapSpriteSets:
	...
	db NORTH_SOUTH,  4, SPRITESET_FUCHSIA,         SPRITESET_PALLET_VIRIDIAN ; SPLITSET_ROUTE_19
