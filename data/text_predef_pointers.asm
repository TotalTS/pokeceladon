...
TextPredefs::
	...
	add_tx_pre ChampionsHouseCupText                ; 1B new
	add_tx_pre MagikarpStatue1Text                  ; 1C new
	add_tx_pre MagikarpStatue2Text                  ; 1D new
	add_tx_pre YoshiMuseumText                      ; 1E new
	...
	add_tx_pre ChikoritaIntroText                   ; 3C new
