...
; entries correspond to PAL_* constants
	...
	RGB 31,29,31, 19,20,24, 20,26,31, 03,02,02 ; PAL_PEWTER
...
IF DEF(_RED)
	RGB 31,29,31, 30,30,17, 17,23,10, 8,25,17 ; PAL_LOGO1
ENDC
IF DEF(_BLUE)
	RGB 31,29,31, 30,30,17, 21,00,04, 8,25,17 ; PAL_LOGO1
ENDC
	RGB 31,29,31, 31,25,06, 18,22,24, 05,12,16 ; PAL_LOGO2
	...
	RGB 31,29,31, 31,28,14, 31,17,12, 03,02,02 ; PAL_YELLOWMON
	RGB 31,29,31, 23,23,25, 16,16,19, 03,02,02 ; PAL_GRAYMON
...
ENDC
	...
	RGB 31,29,31, 25,23,14, 19,16,09, 03,02,02 ; PAL_BRONZEMON
	RGB 31,29,31, 20,22,31, 17,15,23, 03,02,02 ; PAL_VIOLETMON
	RGB 31,29,31, 26,21,22, 15,15,18, 03,02,02 ; PAL_POKETOWER
	RGB 31,29,31, 26,25,14, 14,19,12, 03,02,02 ; PAL_LEMONMON
