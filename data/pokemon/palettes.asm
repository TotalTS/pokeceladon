MonsterPalettes:
	...
	db PAL_BRONZEMON ; SANDSLASH
	db PAL_VIOLETMON ; NIDORAN_F
	db PAL_VIOLETMON ; NIDORINA
	db PAL_VIOLETMON ; NIDOQUEEN
	...
	db PAL_LEMONMON  ; BELLSPROUT
	db PAL_LEMONMON  ; WEEPINBELL
	db PAL_LEMONMON  ; VICTREEBEL
	db PAL_CYANMON   ; TENTACOOL
	db PAL_CYANMON   ; TENTACRUEL
	db PAL_GRAYMON   ; GEODUDE
	db PAL_GRAYMON   ; GRAVELER
	db PAL_BRONZEMON ; GOLEM
	...
	db PAL_LEMONMON  ; EXEGGUTOR
	db PAL_BROWNMON  ; CUBONE
	db PAL_POKETOWER ; MAROWAK
	...
	db PAL_VIOLETMON ; OMANYTE
	db PAL_VIOLETMON ; OMASTAR
	db PAL_BRONZEMON ; KABUTO
	db PAL_BROWNMON  ; KABUTOPS
	db PAL_GRAYMON   ; AERODACTYL
	db PAL_LEMONMON  ; SNORLAX
